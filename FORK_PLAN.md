...
- Add a ranking-provider interface and import format for user CSV/JSON ranks.
...
- Add `get_draft_recommendations` with transparent score components and configurable strategy.
